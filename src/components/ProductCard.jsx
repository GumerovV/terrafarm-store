    ...
    return ( 
        <Link to={`${item.id}`}>
            <div className="font-extralight inline-block relative truncate no-underline mt-4 mr-1.5 mb-0 ml-1.5 p-5 w-72 h-72" key={item.id}>
                    ...
                    <div class="absolute inset-0 flex-col opacity-100 bg-black/100 w-54 h-56 mt-64 hover:opacity-100 hover:bg-black/90 hover:mt-16 ml-5 mr-5 rounded-lg hover:duration-500">
